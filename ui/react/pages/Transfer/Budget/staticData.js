...
export const documentTypes = [
    ...
    { key: '2', name: 'Наказателно постановление' },
    { key: '2', name: 'Авансова вноска' },
    { key: '2', name: 'Данъчен партиден номер на имот' },
    { key: '2', name: 'Постановление за принудително събиране' },
    { key: '9', name: 'Други' }
];
