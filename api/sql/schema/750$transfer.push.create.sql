...
BEGIN TRY
    ...
    DECLARE @result TABLE(
        ...
        [description] [varchar](250),
        [merchantMode] [varchar](20),
        [merchantSettlementDate]  [varchar](50),
        [merchantSerialNumber] [bigint],
        [merchantSettings] [xml],
        issuerMode [varchar](20),
        [issuerSettlementDate]  [varchar](50),
        [issuerSerialNumber] [bigint],
        [issuerSettings] [xml],
        [issuerPort] [varchar](50),
        [ledgerPort] [varchar](50),
    ...
    OUTPUT
        ...
        @merchantMode,
        REPLACE(REPLACE(REPLACE(CONVERT(varchar, @merchantSettlementDate, 120),'-',''),':',''),' ',''),
        @merchantSerialNumber,
        @merchantSettings,
        @issuerMode,
        REPLACE(REPLACE(REPLACE(CONVERT(varchar, @issuerSettlementDate, 120),'-',''),':',''),' ',''),
        @issuerSerialNumber,
        @issuerSettings,
        @issuerPort,
        @ledgerPort,
